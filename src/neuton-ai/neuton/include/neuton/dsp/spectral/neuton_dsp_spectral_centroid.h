/**
 *
 * @defgroup neuton_dsp_spectral_centroid Spectral Centroid
 * @{
 ...
 *
 */
#ifndef _NEUTON_DSP_SPECTRAL_CENTROID_H_
#define _NEUTON_DSP_SPECTRAL_CENTROID_H_
 ...
 *  
 * @return neuton_f32_t Spectral Centroid
 */
neuton_f32_t neuton_dsp_spectral_centroid_f32(neuton_f32_t                   p_spectrum[],
                                              neuton_u16_t                   num,
 ...
 *                                        the calculated value of magnitude_sum and cetroid will be written to context for further use
 *  
 * @return neuton_i16_t Spectral Centroid
 */
neuton_i16_t neuton_dsp_spectral_centroid_i16(neuton_i16_t                   p_spectrum[],
                                              neuton_u16_t                   num,
...
#endif /* _NEUTON_DSP_SPECTRAL_CENTROID_H_ */
